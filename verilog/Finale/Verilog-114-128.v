...
module Verilog_114_128;
    ...
    initial 
        begin
            ...
            // Write the communicated data back to the text files
            while (i > 0)
                begin
                    for (j = 0; j < 8; j++)
                    begin
